...
import cm.app.letsgo.repository.PlanningRepository;
import cm.app.letsgo.repository.search.PlanningSearchRepository;
...
import static cm.app.letsgo.web.rest.TestUtil.sameInstant;
import static cm.app.letsgo.web.rest.TestUtil.createFormattingConversionService;
...
public class PlanningResourceIntTest {
     ...
     *
     * @see cm.app.letsgo.repository.search.PlanningSearchRepositoryMockConfiguration
     */
    @Autowired
